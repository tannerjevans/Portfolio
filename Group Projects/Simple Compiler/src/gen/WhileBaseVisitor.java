...
public class WhileBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements WhileVisitor<T> {
	 ...
	 */
	@Override public T visitFile(WhileParser.FileContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitLine(WhileParser.LineContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitExpr(WhileParser.ExprContext ctx) { return visitChildren(ctx); }
}